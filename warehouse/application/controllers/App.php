...
function gudang(){
		cek_session_admin();
		$data = $this->model_app->view_all_desc('mu_gudang','id_gudang');
        $data = array('record' => $data);
		$this->template->load('app/template','app/mod_gudang/v_gudang',$data);
	}

function tambah_gudang(){
		cek_session_admin();
		if (isset($_POST['submit'])){
			$data = array('nama_gudang' => $this->input->post('a'));
			$this->model_app->insert('mu_gudang',$data);
			redirect('app/gudang');
		}else{
			$this->template->load('app/template','app/mod_gudang/v_tambah_gudang');
		}
	}
...
function edit_gudang(){
		...
		if (isset($_POST['submit'])){
			$data = array('nama_gudang' => $this->input->post('a'));
	    	$where = array('id_gudang' => $this->input->post('id'));
			$this->model_app->update('mu_gudang', $data, $where);
			redirect('app/gudang');
		}else{
			$data['row'] = $this->model_app->edit('mu_gudang', array('id_gudang' => $id))->row_array();
			$this->template->load('app/template','app/mod_gudang/v_gudang_edit',$data);
		}
	}

	function delete_gudang(){
		$id = $this->uri->segment(3);
		$idd = array('id_gudang' => $id);
		$this->model_app->delete('mu_gudang',$idd);
		redirect('app/gudang');
	}
...
function bin(){
		cek_session_admin();
		$data = $this->model_app->view_all_desc('mu_bin','id_bin');
        $data = array('record' => $data);
		$this->template->load('app/template','app/mod_bin/v_bin',$data);
	}

function tambah_bin(){
		cek_session_admin();
		if (isset($_POST['submit'])){
			$data = array('bin_loc' => $this->input->post('a'));
			$this->model_app->insert('mu_bin',$data);
			redirect('app/bin');
		}else{
			$this->template->load('app/template','app/mod_bin/v_tambah_bin');
		}
	}
...
function edit_bin(){
		...
		if (isset($_POST['submit'])){
			$data = array('bin_loc' => $this->input->post('a'));
	    	$where = array('id_bin' => $this->input->post('id'));
			$this->model_app->update('mu_bin', $data, $where);
			redirect('app/bin');
		}else{
			$data['row'] = $this->model_app->edit('mu_bin', array('id_bin' => $id))->row_array();
			$this->template->load('app/template','app/mod_bin/v_bin_edit',$data);
		}
	}
	...
	function delete_bin(){
		$id = $this->uri->segment(3);
		$idd = array('id_bin' => $id);
		$this->model_app->delete('mu_bin',$idd);
		redirect('app/bin');
	}
...
//penyimpanan
	...
	function penyimpanan(){
		...
		cek_session_admin();
		$data = $this->model_app->view_all_desc('mu_penyimpanan','id_penyimpanan');
        $data = array('record' => $data);
		$this->template->load('app/template','app/mod_penyimpanan/v_penyimpanan',$data);
	}

	function tambah_penyimpanan(){
		cek_session_admin();
		if (isset($_POST['submit'])){
	        ...
	        if (trim($this->input->post('p'))==''){
	        	...
	        	$kode_penyimpanan = $this->input->post('p');
	        }

	        if ($hasil['file_name']==''){  
				$data = array('kode_penyimpanan' => $kode_penyimpanan,
							  'kode_pemilik' => $this->input->post('a'),
							  'id_barang' => $this->input->post('b'),
							  'id_gudang' => $this->input->post('c'),
							  'id_rak' => $this->input->post('d'),
							  'id_bin' => $this->input->post('e'),
							  'jumlah' => $this->input->post('q'),
							  'id_satuan' => $this->input->post('r'),
							  'id_pembelian' => $this->input->post('w'),
							  'id_supplier' => $this->input->post('f')
							  );
			}else{
				$data = array('kode_penyimpanan' => $kode_penyimpanan,
							  'kode_pemilik' => $this->input->post('a'),
			...
			$this->model_app->insert('mu_penyimpanan',$data);
			...
			redirect('app/penyimpanan');
		}else{
			//$data['pemilik'] = $this->model_app->view_all_asc('mu_pemilik','id_pemilik');
			$data['gudang'] = $this->model_app->view_all_asc('mu_gudang','id_gudang');
			$data['barang'] = $this->model_app->view_all_desc('mu_barang','id_barang');
			$data['bin'] = $this->model_app->view_all_desc('mu_bin','id_bin');
			$data['rak'] = $this->model_app->view_all_desc('mu_rak','id_rak');
			$data['supplier'] = $this->model_app->view_all_desc('mu_supplier','id_supplier');
			$data['satuan'] = $this->model_app->view_all_desc('mu_satuan','kode_satuan');
			$data['brgmsk'] = $this->model_app->view_all_desc('mu_pembelian','kode_pembelian');
			
			$this->template->load('app/template','app/mod_penyimpanan/v_penyimpanan_tambah', $data);
		}
	}



	function edit_penyimpanan(){
		cek_session_admin();
		$id = $this->uri->segment(3);
		if (isset($_POST['submit'])){
			$data = array('id_gudang' => $this->input->post('a'),
						  'id_rak' => $this->input->post('b'),
						  'id_bin' => $this->input->post('c'),
						  'keterangan' => $this->input->post('d')
						);



	    	$where = array('id_penyimpanan' => $this->input->post('id'));
			$this->model_app->update('mu_penyimpanan', $data, $where);
			redirect('app/penyimpanan');
		}else{
			...
			$data['row'] = $this->model_app->edit('mu_penyimpanan', array('id_penyimpanan' => $id))->row_array();
			$this->template->load('app/template','app/mod_penyimpanan/v_penyimpanan_edit',$data);
		}
	}

	function delete_penyimpanan(){
		$id = $this->uri->segment(3);
		$idd = array('id_penyimpanan' => $id);
		$this->model_app->delete('mu_penyimpanan',$idd);
		redirect('app/penyimpanan');
	}
...
//pemilik 
	function pemilik(){
		cek_session_admin();
		$data = $this->model_app->view_all_desc('mu_pemilik','id_pemilik');
        $data = array('record' => $data);
		$this->template->load('app/template','app/mod_barang/pemilik',$data);
	}


function tambah_pemilik11111111111111111(){
		cek_session_admin();
		if (isset($_POST['submit'])){
			$config['upload_path'] = 'asset/foto_barang/';
	        $config['allowed_types'] = 'gif|jpg|png|JPG|JPEG';
	        ...
	        if (trim($this->input->post('a'))==''){
	        	$kode1 = $this->db->query("SELECT id_supplier FROM mu_supplier ORDER BY id_supplier DESC LIMIT 1")->row();
				$kode_supplier = "PEM-".sprintf("%06s", $kode1->id_supplier+1);
	        }else{
	        	$kode_supplier = $this->input->post('a');
	        }

	        if ($hasil['file_name']==''){  
				$data = array('kode_supplier' => $kode_supplier,
							  'kode_barang' =>  $this->input->post('z'),
							  ...
							  'id_users' => $this->session->id_users,
							  'id_gudang' => $this->input->post('x'),
							  'id_bin' => $this->input->post('y'),
			...
			$this->template->load('app/template','app/mod_barang/view_tambah_pemilik', $data);
		}
	}
//belum selesai
function edit_pemilik(){
		...
		$id = $this->uri->segment(3);
		if (isset($_POST['submit'])){
			$data = array('kode_pemilik' => $kode_pemilik,
							  'id_barang' => $this->input->post('b'),
							  'id_gudang' => $this->input->post('c'),
							  'id_rak' => $this->input->post('d'),
							  'id_bin' => $this->input->post('e'),
			...
			$this->model_app->update('mu_pemilik', $data, $where);
			redirect('app/pemilik');
...
function delete_pemilik(){
		$id = $this->uri->segment(3);
		$idd = array('id_pemilik' => $id);
		$this->model_app->delete('mu_pemilik',$idd);
		redirect('app/pemilik');
	}
...
function tambah_pemilik(){
		...
		if (isset($_POST['submit'])){
			...
			$this->model_app->insert('mu_pemilik',$data);
			$id = $this->db->insert_id();
...
function detail_supplier(){
		cek_session_admin();
		$proses = $this->db->query("SELECT * FROM `mu_supplier` ='".$this->input->post('id')."'")->row_array();
		$data = array('row' => $proses);
		$data['id_supplier'] = $this->model_app->view_all_asc('mu_supplier','id_supplier');
		//$data['conf'] = $this->model_app->view_one('mu_conf_barang',array('id_conf_barang' => 1),'id_conf_barang')->row_array();
		$this->load->view('app/mod_barang/view_detail_supplier',$data);
	}
	...
	function tambah_pembelian(){
		...
		if (isset($_POST['submit'])){
			if (trim($this->input->post('a'))==''){
				...
				$kode_pembelian = "DO-".sprintf("%06s", $kode->id_pembelian+1);
	        }else{
...
function tambah_barang_keluar(){
		...
		if (isset($_POST['submit'])){
			if (trim($this->input->post('a'))==''){
	        	$kode = $this->db->query("SELECT id_pembelian_return FROM mu_pembelian_return ORDER BY id_pembelian_return DESC LIMIT 1")->row();
				$no_return = "BK-".sprintf("%06s", $kode->id_pembelian_return+1);
	        }else{
	        	$no_return = $this->input->post('a');
	        }
			$data = array('no_return' => $no_return,
						  'tgl_kirim_return' => tgl_standard($this->input->post('b')),
						  //'id_karyawan' => $this->input->post('c'),
						  //'id_supplier' => $this->input->post('d'),
						  'id_type_bayar' => $this->input->post('e'),
						  'keterangan_return' => $this->input->post('f'),
						  'tanggal_return' => tgl_standard($this->input->post('g')),
						  //'tgl_terima' => '0000-00-00',
						  //'referensi' => $this->input->post('i'),
						  //'kepada_attention' => $this->input->post('j'),
						  'id_users' => $this->session->id_users,
						  'waktu_return' => date('Y-m-d H:i:s'));
			if ($this->session->id_pembelian_return != ''){
				$where = array('id_pembelian_return' => $this->session->id_pembelian_return);
				$this->model_app->update('mu_pembelian_return', $data, $where);
				$id = $this->session->id_pembelian_return;
			}else{
				$this->model_app->insert('mu_pembelian_return',$data);
				$id = $this->db->insert_id();
			}

			$this->session->set_userdata(array('id_pembelian_return'=>$id));

			$dataa = array('id_pembelian_return' => $id,
						  'id_barang' => $this->input->post('aa'),
						  'jml_return' => $this->input->post('bb'));
			//tambahin rak
						  //'harga_pesan' => $this->input->post('dd')
			$this->model_app->insert('mu_pembelian_return_detail',$dataa);
			redirect('app/tambah_barang_keluar');
		}else{
			if ($this->session->id_pembelian != ''){
				$data['row'] = $this->model_app->edit('mu_pembelian_return', array('id_pembelian_return' => $this->session->id_pembelian_return))->row_array();
			}
			//$data['karyawan'] = $this->model_app->view_all_asc('mu_karyawan','id_karyawan');
			//$data['supplier'] = $this->model_app->view_all_desc('mu_supplier','id_supplier');
			$data['type_bayar'] = $this->model_app->view_all_asc('mu_type_bayar','id_type_bayar');
			$data['barang'] = $this->model_app->view_all_desc('mu_barang','id_barang');
			$this->template->load('app/template','app/mod_pembelian/view_pembelian_tambah_barangkeluar',$data);
		}
	}
	...
	function return_pembelian(){
		...
		if (isset($_POST['submit'])){
			...
			$data = array('id_pembelian_terima' => '1',
						  'no_return' => $no_return,
						  'tgl_kirim_return' => tgl_standard($this->input->post('b')),
	...
	function pembelian_return(){
		cek_session_admin();
		$this->session->unset_userdata('id_pembelian_return');
...
function delete_pembelian_detail1(){
		$id = $this->uri->segment(3);
		$idd = array('id_pembelian_detail' => $id);
		$this->model_app->delete('mu_pembelian_detail',$idd);
		redirect('app/tambah_barang_keluar/'.$this->uri->segment(4));
	}
