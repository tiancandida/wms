...
public function view_pemilik(){
        return $this->db->query("SELECT * FROM mu_pemilik");
    }

public function view_penyimpanan(){
        return $this->db->query("SELECT * FROM mu_penyimpanan");
    }
    ...
    public function view_pembelian(){
        return $this->db->query("SELECT a.*, b.nama_karyawan, c.nama_supplier,  sum(jml_pesan*harga_pesan) as tbayar FROM mu_pembelian a 
