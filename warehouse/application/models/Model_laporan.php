...
class Model_laporan extends CI_model{
    ...
    public function view_penjualan_perbarang($status){
        return $this->db->query("SELECT a.kode_transaksi, a.waktu_proses, x.kode_barang, x.nama_barang, z.jumlah_jual, z.kode_satuan, z.harga_jual, z.diskon_jual, 10/100*(z.jumlah_jual*z.harga_jual) as ppn, ((z.jumlah_jual*z.harga_jual-z.diskon_jual)-10/100*(z.jumlah_jual*z.harga_jual)) as total 
