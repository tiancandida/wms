          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url(); ?>app/pemilik"><i class="fa fa-circle-o"></i> Pemilik Barang</a></li>
               ...
               <!-- <li><a href="<?php echo base_url(); ?>app/penyesuaian"><i class="fa fa-circle-o"></i> Daftar Penyesuaian</a></li> --> 
                <li><a href="<?php echo base_url(); ?>app/barcode"><i class="fa fa-barcode"></i> Label Barcode</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url(); ?>app/pembelian"><i class="fa fa-circle-o"></i> Daftar Delivery Order</a></li>
                <li><a href="<?php echo base_url(); ?>app/pembelian_terima"><i class="fa fa-circle-o"></i> Daftar Terima</a></li>
 <li><a href="<?php echo base_url(); ?>app/tambah_barang_keluar"><i class="fa fa-circle-o"></i> Barang Keluar</a></li>

                <li><a href="<?php echo base_url(); ?>app/pembelian_return"><i class="fa fa-circle-o"></i> Daftar Barang Keluar</a></li>
 ...
 <!--<li class="treeview">-->
             <!-- <a href="#"><i class="glyphicon glyphicon-shopping-cart"></i> <span>Barang Keluar</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu"> -->

               <!--  <li><a href="<?php echo base_url(); ?>app/transaksi_sekarang"><i class="fa fa-circle-o"></i> Data</a></li> -->
         ...
         <!--   </li> -->
           ...
           <!-- <li class="treeview">
            ...
            <!--</li>-->
             ...
             <li><a href="<?php echo base_url(); ?>app/penyimpanan"><i class="fa fa-archive"></i> <span>Penyimpanan</span></a></li>



            <li class="treeview">
              <a href="#"><i class="fa fa-odnoklassniki"></i> <span>User</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="#"><i class="fa fa-circle-o"></i> Data Master <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                  <ul class="treeview-menu menu-open">
            ...
            <li class="treeview">
              <a href="#"><i class="glyphicon glyphicon-cog"></i> <span>Data</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li>
                <a href="#"><i class="fa fa-circle-o"></i> Data Master <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                  <ul class="treeview-menu menu-open">
                    <li><a href="<?php echo base_url(); ?>app/satuan"><i class="fa fa-circle-o"></i> Satuan</a></li>
                   <li><a href="<?php echo base_url(); ?>app/gudang"><i class="fa fa-circle-o"></i> Gudang</a></li>
                   <li><a href="<?php echo base_url(); ?>app/rak"><i class="fa fa-circle-o"></i> Rak Barang</a></li>
                    <li><a href="<?php echo base_url(); ?>app/bin"><i class="fa fa-circle-o"></i> Bin Location</a></li>
