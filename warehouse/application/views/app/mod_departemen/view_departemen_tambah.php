<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('app/tambah_departemen',$attributes); 
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value=''>
                    <tr><th width='150px' scope='row'>Nama Departemen</th>    <td><input type='text' class='form-control' name='a' required></td></tr>
