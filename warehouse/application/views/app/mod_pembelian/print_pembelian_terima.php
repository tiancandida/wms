...
<?php 
  ...
  $spp = $this->db->query("SELECT a.kepada_attention, b.*, c.name as city, d.name as state, e.name as country FROM `mu_pembelian` a 
          ...
          echo "<h2><center>DELIVERY ORDER RECEIVE</center></h2>
                  <hr>
                  <table class='left'>
                  ...
                  <table class='right'>
                    <tr><td width='120px' scope='row'>No. D.O</td>    <td width='6px'>:</td><td> $kode_pembelian</td></tr>
                    <tr><td scope='row'>Tanggal D.O</td>              <td width='6px'>:</td><td> $tgl_kirim</td></tr>
                ...
                <table class='left'>
                  ...
                  <table class='right'>
                    <tr><td width='120px' scope='row'>No. Terima DO</td>  <td width='6px'>:</td><td> $row[no_pembelian_terima]</td></tr>
                ...
                <table id='tablemodul1' width='100%' border='1'>
                      ...
                      <tr class='alert alert-danger'>
                          ...
                          <td colspan='1'></td>
                          <td></td>
                          <td colspan='2'><b style='float:right'> ".($tot['jml'])."</b></td>
