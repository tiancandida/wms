    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-6'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='150px' scope='row'>No. DO</th>    <td><input type='text' class='form-control' name='a' value='$kode_pembelian' required></td></tr>
                ...
                <div class='col-md-6'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='150px' scope='row'>Tanggal DO</th>    <td><input type='text' id='datepickerr' class='form-control' name='g' value='$tgl_pembelian' required></td></tr>
                ...
                <table class='table table-bordered table-striped'>
                      ...
                      <tbody>";
                        ...
                        $tot = $this->db->query("SELECT sum(jml_pesan) as tjumlah FROM `mu_pembelian_detail` where id_pembelian='".$this->uri->segment(3)."'")->row_array();
