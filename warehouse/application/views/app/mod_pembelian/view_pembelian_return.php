    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-6'>
                ...
                <div class='col-md-6'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='150px' scope='row'>No Barang Keluar</th>    <td><input style='width:40%; display:inline-block' type='text' class='form-control' name='a' required></td></tr>
                ...
                <div class='col-md-6'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='150px' scope='row'>Tanggal Barang Keluar</th>    <td><input type='text' id='datepickerr' class='form-control' name='e' required></td></tr>
                  </tbody>
                  </table>
                </div>
