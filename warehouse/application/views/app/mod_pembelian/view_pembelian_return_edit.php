    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-6'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='150px' scope='row'>No. DO</th><td>: $row[kode_pembelian]</td></tr>
                ...
                <div class='col-md-6'>
                  ...
                  <tbody>
                    <tr><th width='150px' scope='row'>Tanggal DO</th> <td>: $row[tgl_pembelian]</td></tr>
                ...
                <div class='col-md-6'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='150px' scope='row'>No Terima DO</th> <td>: $row[no_pembelian_terima]</td></tr>
                ...
                <div class='col-md-6'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='150px' scope='row'>No Barang Keluar</th>    <td><input style='width:40%; display:inline-block' type='text' class='form-control' name='a' value='$row[no_return]' required></td></tr>
                ...
                <div class='col-md-6'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='150px' scope='row'>Tanggal Barang Keluar</th>    <td><input type='text' id='datepickerr' class='form-control' name='e' value='".tgl_slash($row['tanggal_return'])."' required></td></tr>
                  </tbody>
                  </table>
                </div>
