    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-6'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='150px' scope='row'>No. DO</th>   
                     <td><input type='text' style='width:40%; display:inline-block' class='form-control' id='pembelian' name='a' value='$a'> 
                                                                                <label generated='true' class='error' id='message'></label></td></tr>
                    <tr><th width='150px' scope='row'>Tanggal DO</th>    <td><input type='text' id='datepickerr' class='form-control' name='g' value='$g' required></td></tr>
                    <tr><th scope='row'>Petugas</th>    <td><select name='c' class='combobox form-control'>
                                                                  <option value='' selected>Cari Petugas</option>";
                ...
                <table class='table table-bordered table-striped'>
                        ...
                        <tr>
                          ...
                          <td><select name='aa' class='combobox form-control' onchange=\"changeValue(this.value)\" required autofocus>
                                                                ...
                                                                foreach ($barang as $rows){
                                                                    ...
                                                                    $jsArray .= "prdName['" . $rows['id_barang'] . "'] = {desc:'".addslashes($rows['kode_satuan'])."'};\n";
                                                                }
                                                             echo "</select></td>
                          ...
                          <td><input class='form-control' type='text' name='xx' > </td>
                      ...
                      <tbody>";
                        ...
                        $tot = $this->db->query("SELECT sum(jml_pesan) as tjumlah FROM `mu_pembelian_detail` where id_pembelian='".$this->session->id_pembelian."'")->row_array();
                      echo "</tbody>
