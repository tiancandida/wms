    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Terima Delivery Order(DO)</h3>
                </div>
              <div class='box-body'>";
          ...
          echo "<div class='col-md-6'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='150px' scope='row'>No.Delivery Order</th><td>: $kode_pembelian</td></tr>
                ...
                <div class='col-md-6'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='150px' scope='row'>No Terima DO</th>    <td><input style='width:40%; display:inline-block' type='text' class='form-control' id='code' name='a' value='$kode_terima'>
