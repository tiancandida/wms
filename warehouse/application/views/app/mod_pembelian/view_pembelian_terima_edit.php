    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Delivery Order (DO)</h3>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('app/terima_pembelian',$attributes); 
              $x = tgl_slash(date('Y-m-d'));
          ...
          echo "<div class='col-md-6'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='150px' scope='row'>No. Delivery Order </th><td>: $row[kode_pembelian]</td></tr>
                    <tr><th scope='row'>Tanggal Kirim</th>              <td>: $row[tgl_kirim]</td></tr>
                    <tr><th scope='row'>Petugas</th>                    <td>: $row[nama_karyawan]</td></tr>
                ...
                <div class='col-md-6'>
                  ...
                  <tbody>
                    <tr><th width='150px' scope='row'>Tanggal Delivery Order </th> <td>: $row[tgl_pembelian]</td></tr>
                    <tr><th width='150px' scope='row'>Tanggal Terima</th>    <td>: $x</td></tr>
                ...
                <div class='col-md-6'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='150px' scope='row'>No Terima DO</th>    <td><input style='width:40%; display:inline-block' type='text' class='form-control' id='code' name='a' value='$row[no_pembelian_terima]' required>
                ...
                <div class='col-md-6'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='150px' scope='row'>Tanggal Terima</th>    
                    <td><input type='text' id='datepicker' class='form-control' name='x' value='$x' required></td></tr>
