<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('app/tambah_satuan',$attributes); 
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value=''>
                    <tr><th width='120px' scope='row'>Nama satuan</th>    <td><input type='text' class='form-control' name='a' required></td></tr>
