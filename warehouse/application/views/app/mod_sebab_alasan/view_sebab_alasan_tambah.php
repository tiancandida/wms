<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('app/tambah_sebab_alasan',$attributes); 
          echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value=''>
                    <tr><th width='120px' scope='row'>Sebab Alasan</th>    <td><input type='text' class='form-control' name='a' required></td></tr>
